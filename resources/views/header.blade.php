...
<head>
    ...
    <link rel="stylesheet" href="{{url('//cdn.datatables.net/1.12.1/css/jquery.dataTables.min.css')}}">
                            ...
                            <div class="drop-down animated fadeIn dropdown-menu">
                                ...
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{url('images/avatar/4.jpg')}}" alt="">
                                                <div class="notification-content">
