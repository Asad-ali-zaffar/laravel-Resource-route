                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{route('admin.update',$admin[0]->admin_id)}}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-username" placeholder="Enter a username.." value="{{$admin[0]->admin_email}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="Password" class="form-control" id="val-email" name="val-email" placeholder="Your valid Password.." value="{{$admin[0]->password}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
